    ...
    return BlocProvider<AddEventBloc>(
      ...
      child: BlocConsumer<AddEventBloc, AddEventState>(
        listener: (context, state) {
          if (state.status == AddEventStatus.edit) {
            if (_textEditingController.text.isEmpty) {
              _textEditingController.text = state.memoModel.memo;
            } else {
          ...
          return BlocBuilder<AddEventBloc, AddEventState>(
            builder: (context, state) {
              ...
              return AlertDialog(
                ...
                actionsPadding:
                    const EdgeInsets.fromLTRB(0.0, 10.0, 24.0, 20.0),
                contentPadding:
                        ...
                        if (addEventState.status == AddEventStatus.add) {
                          analyticsHelper
                            ...
                            event_select_date_params_position_name:
                                event_select_date_params_position.add
                                    .toString(),
                          });
                        } else if (addEventState.status ==
                            AddEventStatus.edit) {
                          analyticsHelper
                              .logEvent(name: event_select_date, parameters: {
                            event_select_date_params_position_name:
                                event_select_date_params_position.edit
                                    .toString(),
                          });
                        }
